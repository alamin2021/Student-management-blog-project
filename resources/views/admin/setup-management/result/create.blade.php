                    ...
                    <form action="{{url('results')}}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group form-row">
                                    ...
                                    <select class="form-control col-md-9" id="semister_id" name="semister_id">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group form-row col-md-4">
                                ...
                                <select class="form-control col-md-9" id="course_id" placeholder="Course Name "
                                    name="course_id">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group form-row col-md-4">
                                ...
                                <div class="col-md-9">
                                    <input type="number" id="course_code" class="form-control" name="course_code"
                                        readonly>
                                </div>
                            </div>
                            <div class="form-group form-row col-md-4">
                                ...
                                <div class="col-md-9">
                                    <input type="number" id="course_credit" class="form-control" name="course_credit"
                                        readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-row">
                            ...
                            <select class="form-control col-md-9" id="teacher_id" placeholder="Select Teacher  "
                                name="teachers_id">
                        ...
                        <div class="form-group form-row">
                            ...
                            <div class="col-md-9">
                                <input type="number" id="t_credit" class="form-control" name="t_credit"
...
<script type="text/javascript">
    ...
    $('#student_id').on('input', function (e) {
        ...
        $.get('/json-selectCourse?student_id=' + student_id, function (data) {
            ...
            $.each(data, function (index, districtsObj) {
                $('#course_id').append('<option value="' + districtsObj.id + '">' + districtsObj
                    .course_name + '</option>');
            });
        });
    ...
    $('#course_id').on('change', function (e) {
        ...
        $.get('/json-select_std_teacher?course_id=' + course_id, function (data) {
            ...
            $.each(data, function (index, districtsObj) {
                $('#teacher_id').append('<option value="' + districtsObj.id + '">' +
                    districtsObj.name + '</option>');
            });
