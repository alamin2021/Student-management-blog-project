...
@include('messages.message')
    ...
    <div class="card-body form_validate">
        ...
        <form  action="{{url('std_registration/'.$editData->student_id)}}" method="post" enctype="multipart/form-data" id="myForm"  >
            @csrf
        ...
        <div class="row"> 
            <div class="col-md-6">
                <div class="form-group form-row ">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control" id="name" placeholder="Name" name="name" value="{{ $editData->student->name }}" required>
                    </div>
                </div>
                <div class="form-group form-row">
                    <label class=" control-label col-form-label col-md-4">Father's Name</label>
                    <div class="col-md-8">
                        <input type="text" class="form-control" placeholder="Father Name" name="father_name" value="{{ $editData->student->father_name }}" >
                    </div>
                </div>
                <div class="form-group form-row">
                    <label class=" control-label col-form-label col-md-4">Mother  Name <span style="color:red">*</span></label>
                    <div class="col-md-8">
                        <input type="text" class="form-control" placeholder="Mother name" name="mother_name" value="{{ $editData->student->mother_name }}" >
                    </div>
                </div>
                <div class="form-group form-row">
                    <label class="control-label col-form-label col-md-4">Mobile Number <span style="color:red">*</span></label>
                    <div class="col-md-8">
                        <input type="number" class="form-control" placeholder="Mobile Number" name="mobile" value="{{ $editData->student->mobile }}" >
                    </div>
                </div>
                <div class="form-group form-row">
                    <label class="control-label col-form-label col-md-4">Address <span style="color:red">*</span></label>
                    <div class="col-md-8">
                        <input type="text" class="form-control" placeholder="Address" name="present_addr" value="{{ $editData->student->present_addr }}">
                    </div>
                </div>
                ...
                <div class="form-group form-row">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control singleDatePicker"  name="date_of_birth"  value="{{ $editData['student']->date_of_birth }}" />
                    </div>
                </div>
            ...
            <div class="col-md-6">
                <div class="form-group form-row">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control" placeholder="Discount " name="discount" value="{{ $editData->discount->discount }}">
                ...
                <div class="form-group form-row">
                    ...
                    <div class="col-md-8">
                        <select name="year_id" id="" class="form-control">
                            ...
                            <option value="{{ $value->id }}" {{ (@$editData->year_id == $value->id)?'selected':'' }}>{{ $value->year }}</option> 
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="form-group form-row">
                    ...
                    <div class="col-md-8">
                        <select name="shift_id" id="" class="form-control">
                            ...
                            <option value="{{ $value->id }}" {{ (@$editData->shift_id == $value->id)?'selected':'' }} >{{ $value->shift }}</option> 
                            @endforeach
                ...
                <div class="form-group form-row">
                    ...
                    <div class="col-md-8">
                        <select name="group_id" id="" class="form-control">
                            ...
                            <option value="{{ $value->id }} {{ (@$editData->group_id == $value->id)?'selected':'' }}">{{ $value->group }}</option> 
                            @endforeach
                ...
                <div class="form-group form-row">
                    ...
                    <div class="col-md-8">
                        <select name="class_id" id="" class="form-control">
                            ...
                            <option value="{{ $value->id }}" {{ (@$editData->class_id == $value->id)?'selected':'' }}>{{ $value->class_name}}</option> 
                            @endforeach
                ...
                <div class="form-group form-row">
                    ...
                    <div class="col-md-4">
                        <img src="{{ asset('public/backend/images/student/'.$editData->student->image) }}" alt="" id="showImage" style="width:100px;height:100px">
                    </div>
                </div>
            </div>
            
            <button type="submit" class="btn btn-success" value="Validate!" > Update Data </button>
        </div>
        </form>
