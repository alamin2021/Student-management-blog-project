...
<head>
    ...
    <link href="{{asset('backend/stylesheet" href="assets/data-tables/DT_bootstrap.css')}}" />
    {{-- jquery Form validation  --}}
    <link href="{{asset('jquery-validation/demo/css/screen.css')}}" rel="stylesheet" />
  ...
  <section id="container">
      ...
      <!--logo start-->
      <a href="{{url('admin/')}}" class="logo">Ad<span>min</span></a>
      <!--logo end-->
