                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="footer-copyright-left">
                                    &copy; 2020 Industrial Template by BootXperts
                                </div>
                            </div>
                            <div class="col-md-6">
    ...
    <!-- Tippy JS -->
    <script src="{{asset('frontend/assets/js/plugins/tippy.min.js')}}"></script>

    <!-- Light gallery JS -->
    <script src="{{asset('frontend/assets/js/plugins/lightgallery.min.js')}}"></script>

    <!-- Light gallery video JS -->
    <script src="{{asset('frontend/assets/js/plugins/lg-video.min.js')}}"></script>
    ...
    <!-- Gmap3 JS -->
    <script src="{{asset('frontend/assets/js/plugins/gmap3.min.js')}}"></script>

    <!-- Isotope JS -->
    <script src="{{asset('frontend/assets/js/plugins/isotope.min.js')}}"></script>

    <!-- Mailchimp JS -->
    <script src="{{asset('frontend/assets/js/plugins/mailchimp-ajax-submit.min.js')}}"></script>
...
<!-- Mirrored from live.hasthemes.com/html/3/megan-preview/megan/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 26 Sep 2020 15:07:22 GMT -->
</html>