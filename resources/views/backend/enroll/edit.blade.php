...
@section('title','Update Enrolled  A Course ')
        ...
        <div class="card-body ">
          <form action="{{url('enrolles')}}" method="post">
                ...
                <div class="form-group form-row">
                    ...
                    <div class="col-md-9">
                        <input type="text" id="student_name" class="form-control" name="student_name" value="{{$enroll->student_name}}" readonly>
                    </div>
                </div>
                <div class="form-group form-row">
                    <label class=" control-label col-md-3 col-form-label">Student User Name </label>
                    <div class="col-md-9">
                        <input type="text" id="user_name" class="form-control" name="std_usr" value="{{$enroll->std_usr}}" readonly>
                    </div>
                </div>
                <div class="form-group form-row">
                    <label class=" control-label col-md-3 col-form-label"> Student Email </label>
                    <div class="col-md-9">
                        <input type="email" id="email" class="form-control" name="std_eamil" value="{{$enroll->std_eamil}}" readonly>
                    </div>
                </div>
                ...
                <div class="form-group form-row">
                    ...
                    <input type="text" id="department" class="form-control col-md-9" name ="dpt_name"  value="{{$enroll->dpt_name}}" readonly>
                </div>
                ...
                <div class="form-group form-row">
                    ...
                    <select class="form-control col-md-9" id="course_id"  placeholder="Course Name " name="course_id"> 
                        ...
                        <option value="{{$enroll->course_id}}">{{$enroll->course_name}}</option>
                        @endforeach
                   </select>
                </div>
