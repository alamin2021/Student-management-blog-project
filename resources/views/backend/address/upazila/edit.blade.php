...
<div class="col-lg-6 ">
    ...
    <section class="card ">
        ...
        <div class="card-body ">
          <form action="{{url('upazilas/'.$upazila->id)}}" method="post">
                @csrf
                <div class="form-group form-row">
                    ...
                    <select class="form-control col-md-9" id="division"  placeholder="Division Name " name="divisions_id"> 
                        ...
                        @foreach($division as $data)
                            @if($upazila->divisions_id == $data->id )
                ...
                <div class="form-group form-row">
                    ...
                    <select class="form-control col-md-9" id="district"  placeholder="Division Name " name="districts_id"> 
                        ...
                        @foreach($district as $data)
                            @if($upazila->districts_id == $data->id )
                ...
                <div class="form-group form-row">
                    ...
                    <input type="text" class="form-control col-md-9" id="departmetName"  placeholder="Upazila Name " name="upazila_name" value="{{$upazila->upazila_name}}">
                </div>
