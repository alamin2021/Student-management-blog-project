        ...
        <form action="{{url('/about')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="controls col-md-9">
                    <input type="text" class="form-control" id="details_title" placeholder="Details Title  " name="title" >
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="controls col-md-9">
                    <textarea  class="form-control" rows="4" cols="50" id="summernote" placeholder="Describe about yours...." name="description"></textarea>
                </div>
            </div>
